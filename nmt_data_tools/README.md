...
- [jjyaoao 的文本工具箱](#jjyaoao-的文本工具箱)
    - [1.多进程分词](#1多进程分词)
    - [2.词表转换](#2词表转换)
    - [3.文本过滤](#3文本过滤)
    - [4.批量提取 xml 和 sgm](#4批量提取-xml-和-sgm)
      - [4.1 提取单个 xml：](#41-提取单个-xml)
      - [4.2 ⭐ 提取含 xml 的文件夹](#42--提取含-xml-的文件夹)
    - [5.⭐ 写入 xml：](#5-写入-xml)
    - [6.流式输入处理](#6流式输入处理)
    - [7.合并、拆分语料](#7合并拆分语料)
      - [7.1 合并](#71-合并)
    ...
    - [12.⭐ 翻译数据处理](#12-翻译数据处理)
    - [13.后处理](#13后处理)
    - [14.fast\_align 抽取词典](#14fast_align-抽取词典)
    - [15.随机对齐替换(RAS)](#15随机对齐替换ras)
    - [16.⭐ 罕见词、乱码过滤（中文）](#16-罕见词乱码过滤中文)
    - [17.ngram 语言模型](#17ngram-语言模型)
    - [18. MUSE 多语言词典](#18-muse-多语言词典)
    - [19.Annoy 加速相似向量查找](#19annoy-加速相似向量查找)
    - [20.word2vec 初始化 embedding](#20word2vec-初始化-embedding)
    - [21 bpe dropout](#21-bpe-dropout)
    - [22. 可视化：len-bleu](#22-可视化len-bleu)
    - [23. 相似句子查找(LASER 编码)](#23-相似句子查找laser-编码)
    - [24.TextPruner](#24textpruner)
